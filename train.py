...
parser.add_argument("--threads", type=int, default=4, help="threads for data loader to use. Default=8")
parser.add_argument("--decay_epoch", type=int, default=2000, help="epoch from which to start lr decay. Default=1000")
parser.add_argument("--resume", default="", type=str, help="path to checkpoint. Default: none")
parser.add_argument("--start-epoch", default=1, type=int, help="Manual epoch number. Default=1")
parser.add_argument("--n-epoch", type=int, default=4000, help="number of epochs to train. Default=2000")
